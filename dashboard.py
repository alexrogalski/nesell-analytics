...
This file serves as the Streamlit Cloud entrypoint (configured as dashboard.py).
It is identical to app.py. The multi-page app structure uses the pages/ directory.
"""
